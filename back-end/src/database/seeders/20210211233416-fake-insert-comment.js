...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        await queryInterface.bulkInsert('comment', [
            ...
            { id_comment: 6, id_user: 6, id_question: 6, comment: 'É importante questionar o quanto o julgamento imparcial das eventualidades estende o alcance e a importância dos modos de operação convencionais.', created_at: new Date(), updated_at: new Date() },
            { id_comment: 7, id_user: 7, id_question: 6, comment: 'Todavia, o comprometimento entre as equipes maximiza as possibilidades por conta dos índices pretendidos.', created_at: new Date(), updated_at: new Date() },
            ...
            { id_comment: 9, id_user: 5, id_question: 8, comment: 'Evidentemente, o desenvolvimento contínuo de distintas formas de atuação nos obriga à análise do remanejamento dos quadros funcionais.', created_at: new Date(), updated_at: new Date() },
