...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('user', [
      ...
      { id_user: 4, login: 'Apoiador', password: '123456', nivel: 4, created_at: new Date(), updated_at: new Date() },
      { id_user: 5, login: 'Professor', password: '123456', nivel: 5, created_at: new Date(), updated_at: new Date() },
