        ...
        await queryInterface.bulkInsert('question', [
            {
                ...
                issue_resolution: 'Desta maneira, a hegemonia do ambiente político estimula a padronização das regras de conduta normativas.</br>A certificação de metodologias que nos auxiliam a lidar com a mobilidade dos capitais internacionais causa impacto indireto na reavaliação das direções preferenciais no sentido do progresso.</br>Join a community of over 100,000 data-informed developers. Discover best code times, defend code time, see the impact of meetings, and improve work-life balance. Track and visualize all of your projects, or export your data to connect to your billing and timesheet tools',
