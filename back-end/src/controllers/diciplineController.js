                        ...
                        include: [
                            {
                                ...
                                attributes: { exclude: ['id_subject_niv_1', 'created_at', 'updated_at'] },
                                include: {
                                    association: "subject_niv_3",
                                    attributes: { exclude: ['id_subject_niv_2', 'created_at', 'updated_at'] },
                                    // include: {
                                    //     association: "subject_niv_4",
                                    //     attributes: { exclude: ['id_subject_niv_3', 'created_at', 'updated_at'] },
                                    //     // include: {
                                    //     //     association: "subject_niv_5",
                                    //     //     attributes: { exclude: ['id_subject_niv_4', 'created_at', 'updated_at'] },
                                    //     //     // include: {
                                    //     //     //     association: "subject_niv_6",
                                    //     //     //     attributes: { exclude: ['id_subject_niv_5', 'created_at', 'updated_at'] },
                                    //     //     //     // include: {
                                    //     //     //     //     association: "subject_niv_7",
                                    //     //     //     //     attributes: { exclude: ['id_subject_niv_6', 'created_at', 'updated_at'] },
                                    //     //     //     // },
                                    //     //     // },
                                    //     // },
                                    // },
