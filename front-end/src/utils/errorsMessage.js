export const errorsMessage = {
    'auth/invalid-empty-field': 'Por favor preencha todos os campos obrigatórios.',
    'auth/invalid-empty-field-name': 'O nome não pode ficar em branco!',
    'auth/invalid-empty-field-email': 'O email não pode ficar em branco!',
    'auth/invalid-empty-field-passowrd': 'A senha não pode ficar em branco!',
    'auth/invalid-name': 'O nome do usuário é inválido.',
    'auth/invalid-email': 'O email é inválido.',
    'auth/invalid-min-name': 'O nome deve ter no minimo 3 caracteres.',
    'auth/invalid-max-name': 'O nome deve ter no maximo 20 caracteres.',
